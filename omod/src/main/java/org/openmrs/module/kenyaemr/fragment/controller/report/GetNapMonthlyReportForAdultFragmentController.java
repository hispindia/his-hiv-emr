...
public class GetNapMonthlyReportForAdultFragmentController {
	...
	model.addAttribute("noOfMedicallyEligiblePatientsWaitingForARTForFemale",noOfPatientTreatedForOpportunisticInfectionsForFemale);
	...
	model.addAttribute("cumulativeNoOfActiveFollowUpPatientsStartedAtBegOfMonthForFemale",noOfPatientTreatedForOpportunisticInfectionsForFemale);

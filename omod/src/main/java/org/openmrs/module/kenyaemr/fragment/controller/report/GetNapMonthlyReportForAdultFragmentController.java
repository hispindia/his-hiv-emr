...
public class GetNapMonthlyReportForAdultFragmentController {
	...
	Integer noOfPatientsAssessedForAdherenceDuringTheLastMonth=kenyaEmrService.getNoOfPatientsAssessedForAdherenceDuringTheLastMonth(ageCategory,startOfPeriod,endOfPeriod);

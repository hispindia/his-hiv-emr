			 ...
			 KenyaEmrService kenyaEmrService = (KenyaEmrService) Context.getService(KenyaEmrService.class);
		 	  ...
		 	  for(DrugOrderProcessed orderprocess:drugorderprocess)
		 	  {
		 		 if(orderprocess.getPatient().getAge()<=14)
		 			 ...
		 			 {
		 			 if((ptId.equals(orderprocess.getPatient().getPatientId()) &&(orderprocess.getDrugRegimen().equals("ABC/3TC+LPV/r")) && (orderprocess.getDose().equals("60/30+100/25 mg"))))
		 		 ...
		 		 {
		 			if((ptId.equals(orderprocess.getPatient().getPatientId()) &&(orderprocess.getDrugRegimen().equals("ABC/3TC+ LPV/r")) && (orderprocess.getDose().equals("600/300+200/50 mg"))))

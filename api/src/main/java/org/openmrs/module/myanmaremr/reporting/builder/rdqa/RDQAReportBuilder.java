...
package org.openmrs.module.myanmaremr.reporting.builder.rdqa;

import org.openmrs.Concept;
import org.openmrs.EncounterType;
import org.openmrs.PatientIdentifierType;
import org.openmrs.calculation.patient.PatientCalculation;
import org.openmrs.module.myanmarcore.report.HybridReportDescriptor;
import org.openmrs.module.myanmarcore.report.ReportUtils;
import org.openmrs.module.myanmarcore.report.builder.AbstractHybridReportBuilder;
import org.openmrs.module.myanmarcore.report.builder.Builds;
import org.openmrs.module.myanmarcore.report.data.patient.definition.CalculationDataDefinition;
import org.openmrs.module.myanmaremr.Dictionary;
import org.openmrs.module.myanmaremr.calculation.library.hiv.art.CurrentArtRegimenCalculation;
import org.openmrs.module.myanmaremr.calculation.library.hiv.art.InitialArtStartDateCalculation;
import org.openmrs.module.myanmaremr.calculation.library.hiv.art.TransferInDateCalculation;
import org.openmrs.module.myanmaremr.calculation.library.hiv.art.TransferOutDateCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.DateOfDeathCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.DateOfLastCTXCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.PatientCheckOutStatusCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.PatientProgramEnrollmentCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.ValueAtDateOfOtherPatientCalculationCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.VisitsForAPatientCalculation;
import org.openmrs.module.myanmaremr.calculation.library.rdqa.WeightAtArtStartDateCalculation;
import org.openmrs.module.myanmaremr.metadata.CommonMetadata;
import org.openmrs.module.myanmaremr.metadata.HivMetadata;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.CustomDateConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.DateArtStartDateConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.EncounterDatetimeConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.GenderConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.ObsDatetimeConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.ObsValueDatetimeConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.ObsValueNumericConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.PatientEntryPointDataConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.PatientProgramEnrollmentConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.PatientProgramEnrollmentDateConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.RDQACalculationResultConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.RegimenConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.WHOStageDataConverter;
import org.openmrs.module.myanmaremr.reporting.calculation.converter.WeightConverter;
import org.openmrs.module.myanmaremr.reporting.cohort.definition.RDQACohortDefinition;
